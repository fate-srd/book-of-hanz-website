...
const Box = styled.div`
  ...
  margin: 0 auto;
  box-shadow: 0 1.1px 0.9px 0 rgba(0, 0, 0, 0.06), 0 2.7px 2.1px 0 rgba(0, 0, 0, 0.08), 0 5.1px 4px 0 rgba(0, 0, 0, 0.1), 0 9px 7.2px 0 rgba(0, 0, 0, 0.13), 0 16.9px 13.5px 0 rgba(0, 0, 0, 0.15), 0 40.4px 32.3px 0 rgba(0, 0, 0, 0.21);
...
const Hero = () => (
  <HeroWrapper>
    <Box>
      ...
      <Links>
        <li><Button href="#footer">Buy Book $14</Button></li>
        <li><Button href="#footer">Buy PDF $6</Button></li>
      </Links>
    </Box>
  </HeroWrapper>
);
